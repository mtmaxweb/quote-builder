...
export default function QuoteBuilder() {
            ...
            <CardContent className="px-0">
              <div className="space-y-6">
                ...
                {(businessType === "Partnership" || businessType === "Limited Company") && (
                  <div className="space-y-2">
                    <Label htmlFor="number-of-partners">Number of Partners</Label>
                    <Input
  ...
  return (
    <div
      className="min-h-screen bg-[#F4F4F4] flex items-center justify-center p-4"
      ...
      <Card className="w-full max-w-4xl">
        {isSubmitted ? (
          ...
          <div className="flex flex-col md:flex-row">
            <div className="md:w-1/3 bg-[#00ADEE] text-white p-6 rounded-l-lg">
              <h2 className="text-2xl font-bold mb-4">Quote Builder</h2>
              <ul className="space-y-2">
                <li className={`flex items-center ${step >= 1 ? "text-white" : "text-gray-200"}`}>
                  <span
                    className={`w-6 h-6 rounded-full border-2 flex items-center justify-center mr-2 ${step >= 1 ? "border-white" : "border-gray-200"}`}
                  >
                    1
                  </span>
                  Business Type
                </li>
                <li className={`flex items-center ${step >= 2 ? "text-white" : "text-gray-200"}`}>
                  <span
                    className={`w-6 h-6 rounded-full border-2 flex items-center justify-center mr-2 ${step >= 2 ? "border-white" : "border-gray-200"}`}
                  >
                    2
                  </span>
                  Services
                </li>
                <li className={`flex items-center ${step >= 3 ? "text-white" : "text-gray-200"}`}>
                  <span
                    className={`w-6 h-6 rounded-full border-2 flex items-center justify-center mr-2 ${step >= 3 ? "border-white" : "border-gray-200"}`}
                  >
                    3
                  </span>
                  Additional Info
                </li>
                <li className={`flex items-center ${step >= 4 ? "text-white" : "text-gray-200"}`}>
                  <span
                    className={`w-6 h-6 rounded-full border-2 flex items-center justify-center mr-2 ${step >= 4 ? "border-white" : "border-gray-200"}`}
                  >
                    4
                  </span>
                  Contact Details
                </li>
                <li className={`flex items-center ${step >= 5 ? "text-white" : "text-gray-200"}`}>
                  <span
                    className={`w-6 h-6 rounded-full border-2 flex items-center justify-center mr-2 ${step >= 5 ? "border-white" : "border-gray-200"}`}
                  >
                    5
                  </span>
                  Summary
